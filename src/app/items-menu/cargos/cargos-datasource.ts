...
import { CargoAllDto as DadosDto } from '@app/_dto';
import { inject } from '@angular/core';
import { CargosService as DadosService } from '@app/_services';
 ...
 */
export class CargosDataSource extends BaseDataSource<DadosDto> {
