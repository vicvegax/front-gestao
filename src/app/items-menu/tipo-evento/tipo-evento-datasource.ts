...
import { TipoEventoAllDto as DadosDto } from '@app/_dto';
import { inject } from '@angular/core';
import { TipoEventoService as DadosService } from '@app/_services';
 ...
 */
export class TipoEventoDataSource extends BaseDataSource<DadosDto> {
